...
# Formas de pagamento padrão (seed) — inseridas se a tabela estiver vazia
...
def seed_formas_pagamento():
    """Insere formas de pagamento padrão no banco se a tabela estiver vazia."""
    db = SessionLocal()
    try:
...
def health():
    ...
    try:
        ...
        return {
            ...
            "database": "erro",
            "detalhe": str(e),
            "dica": "Verifique se o MariaDB está rodando em localhost:3307 e se o banco 'locacao_veiculos' existe.",
        }
